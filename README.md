...
<p align="center">
I build modern, scalable, and high-performance web interfaces.  
Focused on clean code, smooth user experience, and pixel-perfect UI.
</p>
...
### 🌤️ Weather App
Responsive weather application with real-time API integration.  
**Tech Used:** React • Axios • CSS  
...
### 💱 Currency Converter
Dynamic currency converter with API data fetching.  
**Tech Used:** React • API • Bootstrap  
📁 Repo: YOUR_REPO_HERE  

---

### 💬 Chatbot App
Interactive chatbot using API integration and dynamic UI.  
**Tech Used:** React • JavaScript • API  
📁 Repo: YOUR_REPO_HERE  
